...
Процедура ВКМ_ВыполнитьАвтозаполнение() Экспорт
	...
	РеквизитыДоговора = ОбщегоНазначения.ЗначенияРеквизитовОбъекта(Договор, "ВидДоговора, ВКМ_ДатаНачалаДействияДоговора, ВКМ_ДатаОкончанияДействияДоговора, ВКМ_СуммаЕжемесячнойАбоненсткойПлаты");
	...
	АбоненткаяПлатаПоДоговору = РеквизитыДоговора.ВКМ_СуммаЕжемесячнойАбоненсткойПлаты;
