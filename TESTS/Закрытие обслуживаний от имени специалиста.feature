...
Сценарий: Закрытие обслуживаний от имени специалиста
		И я подключаю TestClient "DiplomУправлениеITФирмой" логин "Владимир" пароль ""
	* И я выбираю в "Добавленные объекты" - "Обслуживание клиента"
			...
			И в таблице "Список" я перехожу к строке:
				...
				| '20.03.2024'            | 'Основной' | 'ООО "Тулаточмаш"' | '9:00:00' | '000000027' | '11:00:00'  | 'Диагностика'       | 'Владимир'   |
